...
-Doesn't look like complete cancer.

-Border-Radius:10px

-Border size increases with GPA
...
-All colors I put in my drop-down actually work properly.
...
-How did that one guy get over 100 percentin  the first assignment?  I'm totally jealous.  I wouldve put more effort into it if i had known that I could get over 100.

-Oh yeah, it's ACTUALLY ON HEROKU.  Seriously, anyone who managed to navigate through Heroku's cancerous website and upload their page from a Windows machine deserves full marks for effort.  How does Heroku even make money?  Their product is godawful.  It has insufficient documentation, it provides false positives for an upload, saying that it loaded properly when it didn't, and its error messages are cryptic at best.  Why is this company still in business?  Bobby, if you're reading this, please find a better solution for the next people who take this course.

That's kinda it.  There isn't a ton to document here - it's just a bunch of css markup combined with the blog tutorial from the rails website.
